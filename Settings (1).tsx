    ...
    <div className="max-w-2xl mx-auto space-y-8 animate-in fade-in zoom-in duration-500 pb-20">
      <div className="glass p-8 rounded-xl border border-zinc-800/50">
        <div className="flex items-center justify-between mb-8">
          ...
          <button 
            onClick={onLogout}
            className="px-4 py-2 bg-red-900/20 text-red-500 border border-red-900/50 rounded-lg text-[10px] font-bold tracking-widest uppercase hover:bg-red-900/40 transition-all"
          >
            Sign Out
          </button>
        </div>
